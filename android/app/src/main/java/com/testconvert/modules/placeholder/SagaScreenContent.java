 ...
 */
public class SagaScreenContent extends FrameLayout implements Content {
    private TextView mTitleTextView;
    private Context mContext;
    private Application mApplication;


    public SagaScreenContent(@NonNull Context context, @NonNull Application application) {
        super(context);
        mContext = context;
    ...
    private void init() {
        ...
        contentView.startReactApplication(mReactInstanceManager, "ReduxSagaScreen", null);
