 ...
 */
public class ButtonScreenContent extends FrameLayout implements Content {
    private TextView mTitleTextView;
    private Context mContext;
    private Application mApplication;


    public ButtonScreenContent(@NonNull Context context, @NonNull Application application) {
        super(context);
        mContext = context;
