 ...
 */
public class AsyncStorageScreenContent extends FrameLayout implements Content {
    private TextView mTitleTextView;
    private Context mContext;
    private Application mApplication;


    public AsyncStorageScreenContent(@NonNull Context context, @NonNull Application application) {
        super(context);
        mContext = context;
    ...
    private void init() {
        ...
        contentView.startReactApplication(mReactInstanceManager, "AsyncStorageScreen", null);
